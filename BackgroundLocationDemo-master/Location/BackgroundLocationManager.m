...
@property (nonatomic, assign) BOOL isStartUpdatingLocation;
@end
...
//    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(applicationEnterBackground) name:UIApplicationDidEnterBackgroundNotification object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(applicationWillBeActive) name:UIApplicationDidBecomeActiveNotification object:nil];
    return self;
    //监听进入后台通知
...
- (void)sendLocalNoification {
    ...
    //Settings
    localNotifications.messages = @[[NSString stringWithFormat:@"自动启动完成 时间:%@",str] ];
    localNotifications.timePeriods = @[]; //days
    localNotifications.appDomain = @"com.mydomain.IDream";
